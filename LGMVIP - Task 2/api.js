...
function getData(a)
{
    ...
    fetch(url).then((response)=>{
      ...
      var mail1=(value['data'][0]['email']);
           document.getElementById('mail1').innerHTML='\xa0\xa0'+mail1+'\xa0\xa0';
           var mail2=(value['data'][1]['email']);
           document.getElementById('mail2').innerHTML='\xa0\xa0'+mail2+'\xa0\xa0';
           var mail3=(value['data'][2]['email']);
           document.getElementById('mail3').innerHTML='\xa0\xa0\xa0'+mail3+'\xa0\xa0\xa0';
           var mail3=(value['data'][3]['email']);
           document.getElementById('mail4').innerHTML='\xa0\xa0\xa0\xa0\xa0'+mail3+'\xa0\xa0\xa0\xa0\xa0';
           var mail3=(value['data'][4]['email']);
           document.getElementById('mail5').innerHTML='\xa0'+mail3+'\xa0';
           var mail3=(value['data'][5]['email']);
           document.getElementById('mail6').innerHTML='\xa0\xa0'+mail3+'\xa0\xa0';
        })
}